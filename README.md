...
```shell
$ wget https://github.com/Amaury/Dispak/archive/0.6.0.zip
$ unzip Dispak-0.6.0.zip

or

$ wget https://github.com/Amaury/Dispak/archive/0.6.0.tar.gz
$ tar xzf Dispak-0.6.0.tar.gz
```
