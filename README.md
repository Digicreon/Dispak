...
```shell
$ wget https://github.com/Amaury/Dispak/archive/0.6.1.zip
$ unzip Dispak-0.6.1.zip

or

$ wget https://github.com/Amaury/Dispak/archive/0.6.1.tar.gz
$ tar xzf Dispak-0.6.1.tar.gz
```
